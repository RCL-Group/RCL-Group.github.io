...
social:
  - icon: hero/envelope
    link: 'mailto:huajian.zeng@mbzuai.ac.ae'
  - icon: brands/google-scholar
    link: https://scholar.google.com/citations?user=RN6p8AEAAAAJ
  - icon: brands/github
    link: https://github.com/huajian-zeng
  - icon: brands/linkedin
    link: https://www.linkedin.com/in/huajian-zeng-7282b8214
  - icon: hero/globe-alt
    link: https://huajian-zeng.github.io/
