...
social:
  - icon: hero/envelope
    link: 'mailto:artem.voronov@mbzuai.ac.ae'
  - icon: brands/google-scholar
    link: https://scholar.google.com/citations?user=rCVVahYAAAAJ
  - icon: brands/github
    link: https://github.com/Vor-Art
  - icon: brands/linkedin
    link: https://www.linkedin.com/in/artem-voronov-inno
